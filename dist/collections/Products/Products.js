        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    allIDs_1 = __spreadArray([], ((products === null || products === void 0 ? void 0 : products.map(function (product) { return (typeof product === "object" ? product.id : product); })) ||
                        []), true);
...
exports.Products = {
    ...
    access: {
        //This important who can access which parts of which products
    ...
    hooks: {
        ...
        // before add product we check if it's new product we want to create before create set product to stripe
        //if product it's exist and we updated set new price to stripe
        beforeChange: [
            addUser,
                    ...
                    switch (_a.label) {
                        case 0:
                            ...
                            return [4 /*yield*/, stripe_1.stripe.products.create({
                                    ...
                                    default_price_data: {
                                        currency: "USD",
                                        unit_amount: Math.round(data.price * 100), // multiplied to 100 because stripe work's with cent
                                    },
                                })];
                        case 1:
